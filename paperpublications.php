...
$Type=$_POST['field31'];
$Level=$_POST['field4'];
$PublisherName=$_POST['field32'];
$Title=$_POST['field33'];
$AcademicYear=$_POST['field34'];
$UGC=$_POST['ugc'];
$Index=$_POST['field5'];
$Impact=$_POST['field3'];
...
if ($uploadOk == 0) {?>
    ...
    alert( "Sorry, your file was not uploaded.kindly Re-submit the Record");
        window.location.href = "Paper Publication.html";</script><?php
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {?><script>
        ...
        $sql = "INSERT INTO paperpublications  VALUES ('$uid','$Type',
'$Level',
'$PublisherName',
'$Title',
'$AcademicYear',
...
if ($db->query($sql) === TRUE) { ?>
	<script>
    window.location.href = "paper publication.html";
