...
if ($uploadOk == 0) {?>
    ...
    alert( "Sorry, your file was not uploaded.kindly Re-submit the Record");
        window.location.href = "achivements.html";</script><?php
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {?><script>
        ...
        $sql = "INSERT INTO achievements  VALUES ('$uid','$Type',
'$Event',
'$Level',
'$Organization',
'$Date',
...
if ($db->query($sql) === TRUE) { ?>
    ...
    window.location.href = "achivements.html";
     alert("One Achievement Record Uploaded Successfully. ");</script><?php
} else {
