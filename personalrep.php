...
?>
 <tr><td><center><table width = "100%" border = "0" cellspacing = "1" cellpadding = "1" style="color:white" bgcolor="#960d0d">
     <!--<tr><td align="center" >EMAIL ID</td>
      ...
      <tr><td align="center"><font style="font-family:'Trebuchet MS'; font-size:18px" text-align:justify"><?php echo $row->email;?></font></td>
        ...
        <tr><td><center><table width = "95%" border = "1" cellspacing = "1" cellpadding = "1" style="color:white" bgcolor="#06adaa"> 
...
?>  
   ...
   <tr><td><center><table width = "95%" border = "1" cellspacing = "1" cellpadding = "1" style="color:black" bgcolor="#c9fcd7"> 
...
?>  
   ...
   <tr><td><center><table width = "95%" border = "1" cellspacing = "1" cellpadding = "1" style="color:black" bgcolor="#c9fcd7"> 
        <tr><td colspan=8><center ><u><font  style="color:black; border:4px solid Tomato;font-family:Georgia;">*PRESENTATIONS*</font></u></center></td></tr>
